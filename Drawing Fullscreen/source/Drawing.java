...
int currentSong = 0;
int ink, black=0, white=0xffFFFFFF, red=0xffFF0000,purple=0xffFF00FF ,blue=0xff0000ff ;
...
public void setup() {
  ...
  //
  circleX = width*3.25f/16;
  circleY = height*2/6;
  circleDiameter = width*7/100;
  ellipse(circleX, circleY, circleDiameter, circleDiameter);
  //
  choiceX = width*5.5f/32;
  choiceY = height*4/6;
  choiceWidth = width*1/16;
  choiceHeight = width*1/16;
  rect(choiceX, choiceY, choiceWidth, choiceHeight);
  //
  choiceX2 = width*5.5f/32;
  choiceY2 = height*1.65f/6;
  choiceWidth2 = width*1/16;
  choiceHeight2 = width*1/16;
  //
  brushButtonX = width*2.25f/6;
  brushButtonY = height*1.75f/16;
  brushButtonWidth = width*3.5f/100;
  brushButtonHeight = width*3.5f/100;
  //
  brushButtonX2 = width*3/6;
  brushButtonY2 = height*1.2f/16;
  brushButtonWidth2 = width*5.5f/100;
  brushButtonHeight2 = width*5.5f/100;
  //
...
public void draw() {
  ...
  text("Colours:", width*0.5f/16, height*1/16, width*2/16, height *2/16);
  text("Circle", width*2.25f/16, height*2.15f/6, width*2/16, height*2/16);
  text("Square", width*2.25f/16, height*3.45f/6, width*2/16, height*2/16);
  text("Image", width*3.055f/4, height*0.5f/1000, width*2/16, height*2/16);
} 
...
public void mouseReleased() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--hide-stop", "Drawing" };
    if (passedArgs != null) {
